...
function GCGUI.newButton(pX, pY, pW, pH, pText, pFont, pColor)
  ...
  function myButton:update(dt)
    ...
    if self.isHover and love.mouse.isDown(1) and
      ...
      self.isPressed = true
      if self.lstEvents["button_level_1"] ~= nil then
        self.lstEvents["button_level_1"]("begin")
      elseif self.lstEvents["button_level_2"] ~= nil then
        self.lstEvents["button_level_2"]("begin")
      elseif self.lstEvents["start_game"] ~= nil then
        self.lstEvents["start_game"]("begin")
      elseif self.lstEvents["start_level_1"] ~= nil then
        self.lstEvents["start_level_1"]("begin")
      elseif self.lstEvents["start_level_2"] ~= nil then
        self.lstEvents["start_level_2"]("begin")
      end
    else
